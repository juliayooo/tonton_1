...
export default function Home(){
  return (
    <div className="pt-[6rem] p-4">
      <Slideshow images={['/assets/home/1.jpg','/assets/home/2.jpg', '/assets/home/3.jpg', '/assets/home/4.jpg']} />
      ...
      <a href="https://www.instagram.com/tonton.matcha.coffee" target="_blank"><img className="mx-auto justify-center max-w-[5vw]" src="/ig.png" alt="matcha" /></a>
    </div>
  )
}
